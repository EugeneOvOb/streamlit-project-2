...
# 2. 開啟指定的試算表與工作表
# ==========================================
SHEET_INPUT = "https://docs.google.com/spreadsheets/d/1CoEjzYYiM4YA18vkD1b-QgxT1P2DJSq71dkK-WfKLms/edit?usp=sharing"
WORKSHEET_NAME = "sheet project"
...
try:
    ...
    # 直接從 secrets 抓取 email，避免 AttributeError
    service_email = st.secrets["gcp_service_account"]["client_email"]
    st.error(
        f"無法開啟試算表，請確認名稱/網址是否正確，且服務帳號 ({service_email}) 已被加入共用編輯者！\n錯誤訊息：{e}"
    )
    st.stop()
